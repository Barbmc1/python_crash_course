...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
	"""Update the positions of bullets & get rid of old bullets."""
...
def check_fleet_edges(ai_settings, aliens):
	"""Respond appropiatly if any aliens have reached an edge."""
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
	"""Check if the fleet is at an edge, and update the positions of 
	    all alliens in the fleet."""
	check_fleet_edges(ai_settings, aliens)
	aliens.update()
	
	#Look for alien-ship collisions.
	if pygame.sprite.spitecollideany(ship, aliens):
		ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets)
...
def get_number_rows(ai_settings, ship_height, alien_hieght):
	"""Determine the number of rows of aliens that fit on the screen."""
	availible_space_y = (ai_settings.screen.height - 
